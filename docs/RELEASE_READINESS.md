...
This is the authoritative closeout record for the independent native Android client.

## Status

- App version: `0.7.4` (`versionCode` 6).
...
- GitHub release APKs are signed by the dedicated project key stored outside source control. Play Store automation is not configured.
...
- Revisit long-thread performance only with a representative sustained-streaming fixture.
